...
import { DEFAULT_AUTH_ERROR, mapAuthError } from './authErrors';
...
describe('auth error mapper', () => {
  it.each([
    ...
    ['Email rate limit exceeded', 'Too many attempts were made. Please wait a few minutes before trying again.'],
